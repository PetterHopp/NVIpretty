...
In this example we have chosen one colour per bin. By having 13 bins, we can display all the clours in the palette.

```{r fig.width = 5} 
ggplot(iris, aes(x = Sepal.Length)) +
  geom_histogram(bins=13, fill=palette_graph ) +
  theme(legend.position = "right")
```
