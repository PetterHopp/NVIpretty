...
#'
#' @details theme_NVI_reprt is a modification of theme_NVI where additional 
#'     specifications are given. In short the theme defines the font, legend 
#'     position, axises,grid lines with colours for lines and background.
#'     
...
#'     Base font family. Defaults to "calibri".
#' @param base_line_size [\code{numeric(1)}]\cr
#'     Base size for line elements. Defaults to 0.5.
#' @param base_rect_size [\code{numeric(1)}]\cr
#'     Base size for rectangular elements. Defaults to 0.5.
